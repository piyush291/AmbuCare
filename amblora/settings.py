"""
Django settings for amblora project.
...
SECRET_KEY = 'zgy7add5@6h4ij%u*yq@mc1me9+dm&%vtfhzgp2*owf5w+4jzv'
...
WSGI_APPLICATION = 'amblora.wsgi.application'
